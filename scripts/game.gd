...
func _ready():
	var save_file = FileAccess.open("user://spaceshooter-save.data", FileAccess.READ)
	if save_file!=null:
...
func save_game():
	var save_file = FileAccess.open("user://spaceshooter-save.data", FileAccess.WRITE)
...
func _on_enemy_spawn_timer_timeout() -> void:
	...
	e.global_position = Vector2(randf_range(40, 500), -50)
